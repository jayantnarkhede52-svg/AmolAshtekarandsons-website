...
const SilverArticles = () => {
    const [images, setImages] = useState([]);
    const [selectedImage, setSelectedImage] = useState(null);

    useEffect(() => {
        const loadImages = async () => {
            const imageModules = import.meta.glob('../assets/Silver articles amol ashtekar/Silver articles amol ashtekar/*.jpg', { eager: true });
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                >
                    <h1 className="text-4xl md:text-5xl font-heading font-bold text-primary-color mb-4">
                        Silver Articles Collection
                    </h1>
                    <div className="w-24 h-1 bg-secondary-color mx-auto mb-6"></div>
                    <p className="text-text-light text-lg max-w-2xl mx-auto">
                        Discover our pure silver collection, featuring intricately designed idols, puja essentials, and elegant gift articles.
                    </p>
                </motion.div>
