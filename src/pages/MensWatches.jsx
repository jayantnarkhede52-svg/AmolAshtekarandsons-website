...
const MensWatches = () => {
    ...
    useEffect(() => {
        const loadImages = async () => {
            const imageModules = import.meta.glob('../assets/Watches men/Watches men/*.jpg', { eager: true });
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                >
                    ...
                    <p className="text-text-light text-lg max-w-2xl mx-auto">
                        Discover our collection of premium men's watches, designed for style and precision.
                    </p>
                </motion.div>
