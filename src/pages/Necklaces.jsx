...
const Necklaces = () => {
    ...
    useEffect(() => {
        const loadImages = async () => {
            const imageModules = import.meta.glob('../assets/Necklaces amol ashtekar/Necklaces amol ashtekar/*.jpg', { eager: true });
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                >
                    ...
                    <p className="text-text-light text-lg max-w-2xl mx-auto">
                        Explore our stunning collection of necklaces, from traditional designs to modern masterpieces, perfect for every occasion.
                    </p>
                </motion.div>
