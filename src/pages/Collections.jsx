...
const Collections = () => {
    const categories = [
        ...
        },
        {
            ...
            link: "/collections/silver-articles"
        },
        {
            id: 6,
            title: "Watches",
                        ...
                        >
                            <Link to={category.link} className="block w-full h-full">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8">
                                    ...
                                    <p className="text-gray-200 text-sm mb-6 md:opacity-0 md:group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-100">
                                        {category.description}
                                    </p>
                                    <span className="inline-block px-6 py-2 bg-secondary-color text-primary-dark font-semibold uppercase tracking-wider text-sm rounded-sm hover:bg-white transition-colors w-max md:opacity-0 md:group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-200">
                                        View Collection
                                    </span>
                                </div>
                            </Link>
