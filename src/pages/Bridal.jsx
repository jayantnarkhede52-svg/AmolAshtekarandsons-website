...
const Bridal = () => {
    ...
    useEffect(() => {
        const loadImages = async () => {
            const imageModules = import.meta.glob('../assets/Bridal jewellery/Bridal jewellery/*.jpg', { eager: true });
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                >
                    ...
                    <p className="text-text-light text-lg max-w-2xl mx-auto">
                        Exquisite bridal collections crafted to make your special day unforgettable.
                        From traditional gold sets to modern diamond masterpieces.
                    </p>
                </motion.div>
